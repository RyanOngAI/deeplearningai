...
You often build helper functions to compute steps 1-3,
...
# In order to define NN structure, you need to understand the shape of your training data
def layer_sizes(X, Y):
    """
    Arguments:
...
# Initialise parameters to randomisation
...
# Forward prop to calculate cost function
